...
$reqobj->add("enquiry","NOT_EMPTY");
$reqobj->add("spam_prevention","NUMERIC");
$out = $reqobj->out();
...
if($ans_one === $ans_two) {
    ...
    $er ='Your spam prevention answer was wrong.<br />Please use the browser back button and try gain.';
    error_found($er,$failure_accept_message,$failure_page);
    die(); 
}
...
if($valid) {
  ...
  foreach($_POST as $field_name => $field_value) {
    if($field_name == "spam_prevention" || $field_name == "answer_p" || $field_name == "enc") {
