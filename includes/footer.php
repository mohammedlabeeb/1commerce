<!-- footer.inc -->
	...
	<div id="leftcolumn">			
                ...
                foreach($categories as $c){
                    if($c->CA_DISABLE == "N"){
						...
						if($c->CA_CODE != "HEADER" and $c->CA_CODE != "SPACER"){
							if($preferences->PREF_SHOP_ACCESS == "Y"){
        ...
        <div id="siteseal-horiz">
            <div class="sf1"><a href="http://www.1-ecommerce.com" rel="nofollow"><span>shopping cart system</span></a></div>
            <div class="sf2"><a href="https://secure.shopfitter.com/cert.cfm" title="This website uses the shopfitter.com secure server"  rel="nofollow"><span>.</span></a></div>
        </div>
