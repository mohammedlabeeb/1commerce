...
<div class="body-wrapper">
        	...
        	<?php 
                if (isset($justloggedout)){
                    ...
                    if ($login == 1){$login_message = "You are now logged in as " . $_SESSION['username']; $login_class="header-login";}else{$login_message = "";}
                }
            ...
            <div class="<?php echo $login_class?>">
                <?php 
				echo $login_message;
                if(strpos($login_message, "logged in")){
			...
			<div class="topnav">
				...
				<?php
					...
					foreach($info as $i){
						...
						if($cntr1 < count($info)){
							echo "<li" . $class . "><a href=\"" . $i->IN_LINK . "\" ><span>" . $i->IN_NAME . "</span></a></li>";
						}else{
							echo "<li" . $class .  "><a href=\"" . $i->IN_LINK . "\" ><span>" . $i->IN_NAME . "</span></a></li>";
						}
					}
